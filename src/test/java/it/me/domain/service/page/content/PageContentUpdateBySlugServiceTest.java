...
class PageContentUpdateBySlugServiceTest {
    ...
    void updatePageContentBySlug_shouldThrowNotFoundException() {
        ...
        given(pageContentReadBySlugRepository.readBySlug(anyString())).willReturn(Optional.empty());

        // when
        NotFoundException nfe = assertThrows(
                NotFoundException.class, () -> sut.updatePageContentBySlug("any", pageContentUpdateRequest));
    ...
    void updatePageContentBySlug_shouldUpdatePageContent() {
        ...
        given(pageContentReadBySlugRepository.readBySlug(anyString())).willReturn(Optional.of(pageContent));

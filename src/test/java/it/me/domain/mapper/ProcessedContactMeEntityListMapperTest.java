...
class ProcessedContactMeEntityListMapperTest {
    ...
    void shouldMapList() {
        // given
        given(processedContactMeMapper.apply(any(ContactMeEntity.class)))
                .willReturn(processedContactMe);

        //when
        List<ProcessedContactMe> apply = sut.apply(List.of(new ContactMeEntity()));

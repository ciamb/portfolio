...
@ApplicationScoped
public class ProcessedContactMeListMapper implements Function<List<ContactMeEntity>, List<ProcessedContactMe>> {
    ...
    @Override
    public List<ProcessedContactMe> apply(List<ContactMeEntity> list) {
